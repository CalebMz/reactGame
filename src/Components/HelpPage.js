    ...
    return (
      <div>
        ...
        <p>
          ...
          card without hitting any bombs. Hitting a bomb will result in a loss
          ...
          nearby indicates there is a bomb card either adjacent, parallel or
          above a card. The game can be restarted at anytime by clicking the
          restart button. Goodluck!
        </p>
